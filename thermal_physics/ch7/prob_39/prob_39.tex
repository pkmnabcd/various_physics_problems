...
To find the max value, I used a substitution of a dimensionless variable: $x=hc/\lambda kT$.
So, $\lambda=hc/xkT$.\\~\\

For $T=300\,\text{K}$, we have the peak wavelength $\lambda_\text{peak}=9.657\times10^{-6}\,\text{m}$.
The following is a plot of $u(\lambda)$.\\
\includegraphics[width=0.7\linewidth]{lambda_vs_spectrum.png}
